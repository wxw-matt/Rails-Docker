...
if [ ! -f "$BUILDX" ]; then
  ...
  curl -LO https://github.com/docker/buildx/releases/download/v0.7.1/buildx-v0.7.1.linux-$(uname -m)
  mkdir -p ~/.docker/cli-plugins
  mv buildx-v0.7.1.linux-$(uname -m) ~/.docker/cli-plugins/docker-buildx
